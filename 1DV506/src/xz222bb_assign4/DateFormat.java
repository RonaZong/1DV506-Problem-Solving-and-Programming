...
//            this.format = "Invalid date";
            throw new IllegalArgumentException("No, this is not possible, error is: ");
        }
    }
    ...
    private void checkMonth(int month) {
        if (month < 1 || month > 12) {
            this.month = 0;
//            this.format = "Invalid date";
            throw new IllegalArgumentException("No, this is not possible, error is: Month must be between 1 and 12.");
        }
    }
    ...
    private void checkDay(int day) {
        if (((this.month == 1 || this.month == 3 || this.month == 5 || this.month == 7 || this.month == 8 || this.month == 10 || this.month == 12)
            ...
            this.day = 0;
//            this.format = "Invalid date";
            throw new IllegalArgumentException("No, this is not possible, error is: Not a valid day that month.");
        }
